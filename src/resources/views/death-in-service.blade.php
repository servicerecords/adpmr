...
@section('content')
    <p class="govuk-body">This RAF application process will not tell you if a service record is held. (
      <a class="govuk-link" href="https://www.gov.uk/get-copy-military-service-records/apply-for-someone-elses-records">Apply by post for Army, Navy &amp; Home Guard records</a>
    )</p>
